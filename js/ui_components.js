...
function injectUI() {
    ...
    document.body.insertAdjacentHTML('afterbegin', UI_PARTS.mainInterface);
    
    // モーダル類を追加 (bodyの最後へ)
    document.body.insertAdjacentHTML('beforeend', UI_PARTS.startOverlay);
    document.body.insertAdjacentHTML('beforeend', UI_PARTS.settingsModal);
    document.body.insertAdjacentHTML('beforeend', UI_PARTS.dbManagerModal);
}